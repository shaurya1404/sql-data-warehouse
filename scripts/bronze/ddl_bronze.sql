...
Naming Convention: <layer>.<source_name>

Script Purpose:
  This script creates all the tables for the bronze layer by first deleting them if they already exist and creating a new one.
  The operations are idempotent if no data is stored in existing tables.
  Run this script to re-define the DDL sturcture of the Bronze tables
*/
